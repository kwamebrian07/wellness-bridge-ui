  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-background hover:bg-muted hover:text-foreground rounded-2xl",
        ...
        hero: "gradient-primary text-white hover:shadow-medium rounded-2xl border-0",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 rounded-2xl shadow-soft",
        medical: "bg-medical-blue text-white hover:bg-medical-blue/90 rounded-2xl shadow-soft",
      },
      size: {
        ...
        fab: "h-14 w-14 rounded-full shadow-medium",
      },
    },
    defaultVariants: {
      variant: "default",
